...
# define E_TRI6 "\tThe three points cannot be aligned.\n"
# define E_TRI7 "· R,G,B colors in range [0,255]: 0, 255, 255\n"
# define E_TRI8 "e.g. tr 10.0,20.0,10.0 10.0,10.0,20.0 20.0,10.0,10.0 0,0,255\n"
